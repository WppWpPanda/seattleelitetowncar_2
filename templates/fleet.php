                ...
                <div class="col-xs-12">
                    <div class="header-short" role="heading" aria-level="2">
                        ...
                        <a href="<?php echo htmlspecialchars($fleetConfig['section']['reservation_btn']['url']); ?>"
                           ...
                           aria-label="<?php echo htmlspecialchars($fleetConfig['section']['reservation_btn']['text']); ?>">
                    ...
                    foreach ($fleetConfig['vehicles'] as $vehicle): ?>
                        <div class="fleet-item<?php echo $i%2 === 0 ? ' flex-reverse' : ''; ?>">
                            <figure class="fleet-item__figure">
                                <img class="fleet-item__img  lazy-img"
                                     data-src="<?php echo htmlspecialchars($vehicle['main_img']); ?>"
                                     alt="<?php echo htmlspecialchars($vehicle['main_alt']); ?>"
                                     aria-hidden="false"
                                >
                                <img class="fleet-item__imgin lazy-img"
                                     data-src="<?php echo htmlspecialchars($vehicle['inner_img']); ?>"
