jQuery(function ($) {
    var tabs = 5;
    var sliders = ["#fleetsedans", "#fleetsuvs", "#fleetvans", "#fleetlimos", "#fleetbuses"];
    ...
    function turnOnEvents(slider) {
        ...
        nextArrow.on('click', function (event) {
            ...
            if (slickCurrentSlide == slick.$slides.length - 1) {
                nextTab();
            } else {
                slick.slickNext();
            }
    ...
    function initSlider(slider) {
        ...
        $(slider + "S").slick({
            ...
            nextArrow: nextArrow,
            variableWidth: true,
            responsive: [{breakpoint: 1200, settings: {slidesToShow: 1, slidesToScroll: 1, infinite: 1}}, {
                breakpoint: 992,
                settings: {slidesToShow: 1, slidesToScroll: 1, infinite: 1}
            }, {breakpoint: 640, settings: {slidesToShow: 1, slidesToScroll: 1, infinite: 1}}]
        });
